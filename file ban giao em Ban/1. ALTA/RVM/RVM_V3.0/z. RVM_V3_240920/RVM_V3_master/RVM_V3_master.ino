...
void taskSerial(void *parameters)
{
  while (1)
  {
    ...
    if (SerialPC.isReceived)
    {
      ...
      {
        Serial2.write(ui8_buffer_receive_PC[i]);
      }
    }
    processSerial();
    ...
    case code::admin_control_motor:
    {
           ...
           ui8_buffer_receive_PC[6] != TrangThaiMotor::REVERSE))
      {
        ...
        case admin_control::CUA:
        {
          ...
          Serial.print("Cua: ");
          Serial.println(MotorCua.YeuCau);
        ...
        case admin_control::BANGTAI:
        {
          ...
          Serial.print("Bang tai: ");
          Serial.println(MotorBangTai.YeuCau);
          break;
        }
        ...
        {
          MotorPhanLoai1.YeuCau = ui8_buffer_receive_PC[6];
          break;
        }
        ...
        {
          MotorEpLon.YeuCau = ui8_buffer_receive_PC[6];
          break;
        }
        case admin_control::NGHIENCHAI:
        {
          MotorNghienChai.YeuCau = ui8_buffer_receive_PC[6];
          break;
        }
        default:
...
#if 0
      if (ui8_buffer_receive_PC[4] == admin_control::CUA &&
          ui8_buffer_receive_PC[5] == TrangThaiMotorCua::CUA_DUNGLAI)

        ;
      else if (ui8_buffer_receive_PC[4] == admin_control::CUA &&
               ui8_buffer_receive_PC[5] == TrangThaiMotorCua::CUA_NANGLEN)

        ;
      else if (ui8_buffer_receive_PC[4] == admin_control::CUA &&
               ui8_buffer_receive_PC[5] == TrangThaiMotorCua::CUA_HAXUONG)

        ;
      else if (ui8_buffer_receive_PC[4] == admin_control::BANGTAI &&
               ui8_buffer_receive_PC[5] == TrangThaiMotorBangTai::BANGTAI_DUNGLAI)
        ;

      else if (ui8_buffer_receive_PC[4] == admin_control::BANGTAI &&
               ui8_buffer_receive_PC[5] == TrangThaiMotorBangTai::BANGTAI_CHAYVAO)
        ;

      else if (ui8_buffer_receive_PC[4] == admin_control::BANGTAI &&
               ui8_buffer_receive_PC[5] == TrangThaiMotorBangTai::BANGTAI_CHAYRA)

        ;
      else if (ui8_buffer_receive_PC[4] == admin_control::NANGBANGTAI &&
               ui8_buffer_receive_PC[5] == TrangThaiMotorNangBangTai::NANGBANGTAI_DUNGLAI)

        ;

      else if (ui8_buffer_receive_PC[4] == admin_control::NANGBANGTAI &&
               ui8_buffer_receive_PC[5] == TrangThaiMotorNangBangTai::NANGBANGTAI_NANGLEN)
        ;

      else if (ui8_buffer_receive_PC[4] == admin_control::NANGBANGTAI &&
               ui8_buffer_receive_PC[5] == TrangThaiMotorNangBangTai::NANGBANGTAI_HAXUONG)
        ;
      else if (ui8_buffer_receive_PC[4] == admin_control::XOAYCHAI &&
               ui8_buffer_receive_PC[5] == TrangThaiMotorXoayChai::XOAYCHAI_STOP)
        ;
      else if (ui8_buffer_receive_PC[4] == admin_control::XOAYCHAI &&
               ui8_buffer_receive_PC[5] == TrangThaiMotorXoayChai::XOAYCHAI_LEFT)
        ;
      else if (ui8_buffer_receive_PC[4] == admin_control::XOAYCHAI &&
               ui8_buffer_receive_PC[5] == TrangThaiMotorXoayChai::XOAYCHAI_RIGHT)
        ;
      else if (ui8_buffer_receive_PC[4] == admin_control::PHANLOAI1 &&
               ui8_buffer_receive_PC[5] == TrangThaiMotorPhanLoai1::PHANLOAI1_STOP)
        ;
      else if (ui8_buffer_receive_PC[4] == admin_control::PHANLOAI1 &&
               ui8_buffer_receive_PC[5] == TrangThaiMotorPhanLoai1::PHANLOAI1_LEFT)
        ;
      else if (ui8_buffer_receive_PC[4] == admin_control::PHANLOAI1 &&
               ui8_buffer_receive_PC[5] == TrangThaiMotorPhanLoai1::PHANLOAI1_RIGHT)
        ;
      else if (ui8_buffer_receive_PC[4] == admin_control::PHANLOAI2 &&
               ui8_buffer_receive_PC[5] == TrangThaiMotorPhanLoai2::PHANLOAI2_STOP)
        ;
      else if (ui8_buffer_receive_PC[4] == admin_control::PHANLOAI2 &&
               ui8_buffer_receive_PC[5] == TrangThaiMotorPhanLoai2::PHANLOAI2_LEFT)
        ;
      else if (ui8_buffer_receive_PC[4] == admin_control::PHANLOAI2 &&
               ui8_buffer_receive_PC[5] == TrangThaiMotorPhanLoai2::PHANLOAI2_RIGHT)
        ;

      else if (ui8_buffer_receive_PC[4] == admin_control::EPLON &&
               ui8_buffer_receive_PC[5] == TrangThaiMotor::STOP)

        ;

      else if (ui8_buffer_receive_PC[4] == admin_control::EPLON &&
               ui8_buffer_receive_PC[5] == TrangThaiMotor::FORWARD)

        ;

      else if (ui8_buffer_receive_PC[4] == admin_control::EPLON &&
               ui8_buffer_receive_PC[5] == TrangThaiMotor::REVERSE)
        ;

      else if (ui8_buffer_receive_PC[4] == admin_control::NGHIENCHAI &&
               ui8_buffer_receive_PC[5] == TrangThaiMotor::STOP)
