...
SerialUSB SerialPC(Serial2, selfSlaveID);

//-----------UART DEBUG ------------//
#define SerialDebug Serial

//-----------RS485 Communication------------//
RS485_Master RS485(Serial1, RS485_TX_PIN, RS485_RX_PIN, RS485_DE_PIN);
#define slave1 0x09
...
uint8_t ui8_buffer_receive_slave[20];
...
namespace code
{
  ...
  // send_state_cambienPhathienvat = 0x08,
