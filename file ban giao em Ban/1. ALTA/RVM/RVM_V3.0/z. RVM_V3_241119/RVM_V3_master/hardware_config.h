...
Input_PCF8574 CamBien1(pcf_PortA, PIN_A1, LOW);
Input_PCF8574 CamBien2(pcf_PortA, PIN_A2, LOW);
Input_PCF8574 CamBien3(pcf_PortA, PIN_A3, LOW);
Input_PCF8574 CamBien4(pcf_PortA, PIN_A4, LOW);
Input_PCF8574 CamBien5(pcf_PortA, PIN_A5, LOW);
Input_PCF8574 CamBien6(pcf_PortA, PIN_A6, LOW);
Input_PCF8574 CamBien7(pcf_PortA, PIN_A7, LOW);
Input_PCF8574 CamBien8(pcf_PortA, PIN_A8, LOW);

Input_PCF8574 CamBien9(pcf_PortB, PIN_B1, LOW);
Input_PCF8574 CamBien10(pcf_PortB, PIN_B2, LOW);
Input_PCF8574 CamBien11(pcf_PortB, PIN_B3, LOW);
Input_PCF8574 CamBien12(pcf_PortB, PIN_B4, LOW);
Input_PCF8574 CamBien13(pcf_PortB, PIN_B5, LOW);
Input_PCF8574 CamBien14(pcf_PortB, PIN_B6, LOW);
Input_PCF8574 CamBien15(pcf_PortB, PIN_B7, LOW);
Input_PCF8574 CamBien16(pcf_PortB, PIN_B8, LOW);

// Mảng lưu địa chỉ các đối tượng cảm biến
...
CoCauMotorDC MotorCua(Motor_M1, 10000);
CoCauMotorDC MotorBangTai(Motor_M2, 10000, true);
CoCauMotorDC MotorNangBangTai(Motor_M3, 10000);
CoCauMotorDC MotorXoayChai(Motor_M4, 10000, true);
CoCauMotorDC MotorPhanLoai1(Motor_M5, 10000);

CoCauMotorDC *MotorDCArray[] = {&MotorCua, &MotorBangTai, &MotorNangBangTai, &MotorXoayChai, &MotorPhanLoai1};
