...
Sensor CB_LongEp1(SEN1, LOW);
Sensor CB_LongEp2(SEN2, LOW);
Sensor CB_DauEp(SEN3, LOW);
Sensor CB_Rac3(SEN4, LOW);

Sensor *CB_Array[] = {&CB_LongEp1, &CB_LongEp2, &CB_DauEp, &CB_Rac3};
...
CoCauMotorServo *MotorServoArray[1] = {&MotorEpLon};
