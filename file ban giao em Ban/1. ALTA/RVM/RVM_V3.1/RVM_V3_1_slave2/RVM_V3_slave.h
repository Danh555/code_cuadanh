...
#include "src/SerialComunicationv2.h"
#include "src/ReadSensorDebounce.h"

// #define CoVatMoiChayEpLon // Chỉ khi có vật sau khi master gửi lệnh mới chạy ép
#define GuiLenhLaEpLon // Nhận lệnh, timeout mà không có vật thì ép mặc định
...
struct
{
  ...
  const uint16_t timeErrorGoBack = 6000;
