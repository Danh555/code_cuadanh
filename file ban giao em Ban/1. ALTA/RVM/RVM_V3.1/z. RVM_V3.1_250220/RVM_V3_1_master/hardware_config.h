...
Sensor CB_Cua1(SEN1, LOW);
Sensor CB_Cua2(SEN2, LOW);
Sensor CB_Cua3(SEN3, LOW);
Sensor CB_Cua4(SEN4, LOW);
Sensor CB_KL1(SEN5, LOW);
Sensor CB_KL2(SEN6, LOW);
Sensor CB_Nang(SEN7, LOW);
Sensor CB_Vat1(SEN8, LOW);
Sensor CB_Vat2(SEN9, LOW);

Sensor *CB_Array[] = {&CB_Cua1, &CB_Cua2, &CB_Cua3, &CB_Cua4, &CB_KL1, &CB_KL2, &CB_Vat1, &CB_Vat2, &CB_Nang};
