...
Sensor CB_PhanLoai1_Trai(SEN1, LOW);
Sensor CB_PhanLoai1_Phai(SEN2, LOW);
Sensor CB_Encoder(SEN3, LOW);
Sensor CB_Rac1(SEN4, LOW);
Sensor CB_Rac2(SEN5, LOW);

Sensor *CB_Array[] = {&CB_PhanLoai1_Trai, &CB_PhanLoai1_Phai, &CB_Encoder, &CB_Rac1, &CB_Rac2};
...
CoCauMotorDC MotorPhanLoai1(Motor_M1, false);
...
CoCauMotorServo *MotorServoArray[] = {&MotorNghienChai};
