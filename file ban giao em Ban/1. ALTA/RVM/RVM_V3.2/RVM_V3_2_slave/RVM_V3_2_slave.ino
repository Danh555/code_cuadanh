...
void timerReadSensor(void *pvParameters)
{
    ...
    CTHT_Cuaduoi.readDebounce(10);
    CTHT_Cuatren.readDebounce(10);

    CB_LongEp1.readDebounce(100);
    CB_LongEp2.readDebounce(100);
    CB_Rac1.readDebounce(1000);
    CB_Rac2.readDebounce(1000);
    CB_Rac3.readDebounce(1000);
}
...
void phanhoi_trangthailoi()
{
    ...
    SerialDebug.printf("\nguiphanhoichoMaster: %D %D %D\n",
                       trangthai_Phanloai, trangthai_Nghien, trangthai_Ep, CB_Rac1.state,
                       CB_Rac2.state, CB_Rac3.state, CTHT_Cuaduoi.state, CTHT_Cuatren.state);
#endif
}
