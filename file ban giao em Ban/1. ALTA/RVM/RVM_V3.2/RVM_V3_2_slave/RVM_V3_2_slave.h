...
//-----------Firmware number------------//
uint8_t firmware[3] = {3, 2, 2};

// 3.2.2 : coppy từ 3.2.2  dành cho máy 3.2(máy remake từ máy v2)
//-----------UART DEBUG ------------//
...
struct
{
  ...
  const uint16_t timeError_phanloai1 = 5000;
...
struct
{
  ...
  const uint32_t timeAutoStop = 600000; // 10 phút
