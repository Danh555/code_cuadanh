...
Input_PCF8574 CTHT_Cuatren(pcf_PortA, PIN_A7, LOW);
Input_PCF8574 CTHT_Cuaduoi(pcf_PortA, PIN_A8, LOW);

Input_PCF8574 CB_Rac1(pcf_PortB, PIN_B1, LOW);
Input_PCF8574 CB_Rac2(pcf_PortB, PIN_B2, LOW);
Input_PCF8574 CB_Rac3(pcf_PortB, PIN_B3, LOW);
Input_PCF8574 CB_PhanLoai2_Trai(pcf_PortB, PIN_B7, LOW);
Input_PCF8574 CB_PhanLoai2_Phai(pcf_PortB, PIN_B8, LOW);

Input_PCF8574 *CB_Array[] = {&CB_Encoder, &CB_PhanLoai1_Trai, &CB_PhanLoai1_Phai, &CB_DauEp,
                             &CB_LongEp1, &CB_LongEp2, &CB_PhanLoai2_Trai, &CB_PhanLoai2_Phai,
                             &CTHT_Cuaduoi, &CTHT_Cuatren, &CB_Rac1, &CB_Rac2, &CB_Rac3};
