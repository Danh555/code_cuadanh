...
// void ledsaobang(byte r, byte g, byte b)
// {
// 	if ((millis()-timeLED)>=updateLed)
// 	{
// 		if (posLED < LED_COUNT + SIZE)
// 		{
...
//     		// 2. Vẽ sao băng (SIZE LED sáng kéo nhau)
// 			for (int j = 0; j < SIZE; j++) 
// 			{
// 			int index = posLED - j;
// 			if (index >= 0 && index < LED_COUNT) 
// 				{
// 					pixels1.setPixelColor(index, pixels1.Color(r, g, b));
// 				}
// 			}
