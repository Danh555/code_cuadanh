...
void loop() 
{
	...
	// 	// process_upfile();			/*S3*/
		...
		if(ui32_timeout_formatdisk<=millis() && ui8_dangupdate_mqtt==0)
		{
	...
	if(system_running_mode ==0)
	{
		...
		if(u32check_firmware>millis() && ui8_busy_rec_printer == 0)
		{
