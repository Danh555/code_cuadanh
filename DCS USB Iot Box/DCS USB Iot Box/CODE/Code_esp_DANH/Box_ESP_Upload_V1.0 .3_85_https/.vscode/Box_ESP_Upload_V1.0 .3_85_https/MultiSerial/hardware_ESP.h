...
//KHAI BAO CHAN KICH PIN DU PHONG
#define POWER_PIN 48

//KHAI BAO CHAN DOC NGUON
#define READ_POWER 2
...
void hardware_init(uint32_t baudrate)
{
   ...
   // digitalWrite(READ_POWER,1);
   
   SerialToPrinter.begin(115200,SERIAL_8N1,SerialToPrinter_tx,SerialToPrinter_rx);
   SerialToBarcodeModem.begin(baudrate,SERIAL_8N1,SerialToBarcodeModem_tx,SerialToBarcodeModem_rx);
