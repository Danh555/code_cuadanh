...
const char HTTP_BAUDRATE_MODE_SELECTION[] PROGMEM      = "<br/><label for=\"modef1\">-Baud Rate :</label><select name=\"modef2\" id=\"modef12\"><option value=\"0\">9600</option><option value=\"1\">115200</option><option value=\"2\">230400</option><option value=\"3\">460800</option></select>";
