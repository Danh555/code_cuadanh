...
void connect_MQTT_ATCMD()
{
	...
	kt_connect = sendATCommand("AT+CMQTTCONNECT=0,"+(String) (domain_name)+",3000,0,"+(String) (username)+","+(String) (password),500);
