...
uint8_t buffer_version_slave1[4];
uint8_t buffer_version_slave2[4];
uint8_t buffer_version_slave3[4];
uint8_t buffer_version_slave4[4];
uint8_t buffer_version_slave5[4];
...
uint32_t ui32_timeout_guifw=0;
uint32_t ui32_timeout_guiphanhoi=0;
uint32_t ui32_timeout_hetguifw=0;


char nameOnly[32]; // Bộ nhớ đủ để chứa tên file
char nameOnly_finish[32];
char nameOnly_uncut[10];
uint32_t ui32_timeout_checkspiffs=0;
static unsigned long timeout=0;

char *slave1_test="test_filespiffs";
char *slave2_test="test_filespiffs1";

bool ui2_sendOK = true;
bool  ui2_update_firmware=false;

uint8_t ui8_reset_all=0;
uint8_t ui8_rs_master=0;
...
uint8_t ui8_danggui_fw=0;
uint8_t ui8_upfw_slave1=0;
uint8_t ui8_upfw_slave2=0;
uint8_t ui8_upfw_slave3=0;
uint8_t ui8_upfw_slave4=0;
uint8_t ui8_upfw_slave5=0;

char filename_update[100];
uint8_t ui8_fw_can_up=0;