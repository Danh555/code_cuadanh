...
{ 
  for(;;)
  {
    ...
    //       ui8_function = 0x14;
    //       send_state_to_PC(ui8_function);
    //       // motor_ep.ui8_phanhoitrangthai=TrangThaiLenhPhanHoi::DUNG;
    ...
    //       ui8_function = 0x16;
    //       send_state_to_PC(ui8_function);
    //       // motor_nghien.ui8_phanhoitrangthai=TrangThaiLenhPhanHoi::DUNG;
    ...
    //       ui8_function = 0x17;
    //       send_state_to_PC(ui8_function);
    //       // motor_phanloai.ui8_phanhoitrangthai=TrangThaiLenhPhanHoi::DUNG;
    ...
    //     if(ui8_trangthai_thungraclon==1 && ui8_trangthaithungraclon==TrangThaiThungRac::KHONGDAY)
    //     {
    ...
    //     if(ui8_trangthai_thungrackhac==1 && ui8_trangthaithungrackhac==TrangThaiThungRac::KHONGDAY)
    //     {
    ...
    //     }
    //     ui8_lenhkiemtramay=0;
    //   }      

    //   else
    //   {
    //     if(motor_nangha.ui8_kiemtra_trangthailoi_motorDC == TrangthaiLoi::KHONGLOI)
    //     {
    //       ui8_function = 0x15;
    //       send_state_to_PC(ui8_function);
    //       // motor_nangha.ui8_phanhoitrangthai=TrangThaiLenhPhanHoi::DUNG;
    ...
    //       delay(500);
    //     }
    //     if(motor_ep.ui8_kiemtra_trangthailoi == TrangthaiLoi::KHONGLOI){
    //       ui8_function = 0x14;
    //       send_state_to_PC(ui8_function);
    //       // motor_ep.ui8_phanhoitrangthai=TrangThaiLenhPhanHoi::DUNG;
    //       Serial_Debug.printf("MOTOR EP LON DANG LOI\n");
    ...
    //       delay(500);
    //     }
    //     if(motor_phanloai.ui8_kiemtra_trangthailoi == TrangthaiLoi::KHONGLOI){
    //       ui8_function = 0x17;
    //       send_state_to_PC(ui8_function);
    //       // motor_phanloai.ui8_phanhoitrangthai=TrangThaiLenhPhanHoi::DUNG;
    //       Serial_Debug.printf("MOTOR PHAN LOI DANG LOI\n");
      ...
      case ARDUINO_HW_CDC_RX_EVENT:
        ...
        while (Serial_Debug.available()) 
        {
          ...
          if(input=="nhahang")
          {
            ...
            ui8_control_hang=0x03;
            ui8_control_cot=0x03;
...
void quatrinh_3()
{
  ...
  if(cholayvat==1)
  {
    int tam=doccambien(cambien_vat1,200);// cb ben ngoai
    ...
    else if(tam2==0 && ui32_timemotor_bangtai <= millis())
    {
      process_1 = 0;
      process_2 = 0;
      process_3 = 0;
    ...
    if(ui8_vatrangoai==1)
    {
        ...
        //  {
          ...
          if(tam==0 && ui32_timemotor_bangtai <= millis())
          {
            process_1 = 0;
            process_2 = 0;
            process_3 = 0;
