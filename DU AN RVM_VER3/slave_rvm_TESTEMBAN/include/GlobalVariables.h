...
//-----------Firmware number------------//
uint8_t firmware[4] = {3, 1, 0, 1};

#define BUFFER_SIZE DATA_SIZE + HEADER_SIZE
#define DATA_SIZE 10240 // Kích thước gói dữ liệu
#define HEADER_SIZE 7   // Kích thước header size
	...
	namespace vitricua
	{
		const uint8_t CUATREN = 0x01;
		const uint8_t CUADUOI = 0x02;
	};
...
namespace TrangThaiCua
{
	uint8_t BINHTHUONG=0x00;
	uint8_t MOCUA=0x02;
	uint8_t DONGCUA=0x01;
};
...
uint8_t ui8_trangthai_cuatren=TrangThaiCua::DONGCUA;
uint8_t ui8_trangthai_cuaduoi=TrangThaiCua::DONGCUA;
...
uint32_t ui32_timeout_mocua=0;
uint32_t ui32_timeout_kiemtraloi=0;
uint32_t ui32_timeout_dongcua=0;

uint8_t ui8_checkmocua=0;
uint8_t ui8_checkdongcua=0;

uint8_t ui8_yeucau=binhthuong;
uint8_t ui8_controlcuatren=0;
uint8_t ui8_controlcuaduoi=0;
uint8_t ui8_vitricua=0;
uint8_t ui8_controlcua=0;
uint8_t ui8_phanhoi_firmware=0;
uint8_t ui8_update_firmware=0;

uint8_t ui8_resetbien=0;
uint32_t ui32_timeout_checktrangthai=0;
