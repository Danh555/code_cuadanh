...
// unsigned char ROW[12] = {ROW_1, ROW_2, ROW_3, ROW_4, ROW_5, ROW_6, ROW_7, ROW_8, ROW_9, ROW_10, ROW_11, ROW_12};//may bth
...
uint16_t Vitrilaysanpham[6] = {750, 1530, 2330, 3030, 3710, 4230}; // may so 9 25/11/2025
