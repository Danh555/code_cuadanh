...
// }
void BTS7960::TurnRight(uint8_t pwm){
     // analogWrite(_R_EN, pwm);
	 // delayMicroseconds(100);
     analogWrite(_L_EN, pwm);
	 digitalWrite(_R_PWM, 1);
	  delayMicroseconds(100);
	 digitalWrite(_L_PWM, 0);
}
...
void BTS7960::TurnLeft(uint8_t pwm){
	 ...
	 // delayMicroseconds(100);
     analogWrite(_L_EN, pwm);
	digitalWrite(_R_PWM, 0);
	  delayMicroseconds(100);
	digitalWrite(_L_PWM, 1);
}
...
void BTS7960::Stop(){
	// analogWrite(_R_EN, LOW);
	// analogWrite(_L_EN, LOW);
